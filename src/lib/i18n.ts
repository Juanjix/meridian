  ...
  en: {
    ...
    bookingPage: {
      ...
      step2: {
        ...
        phoneNote: 'Used only to coordinate your arrival.',
        companyLabel: 'Company',
        optionalCompany: '(optional)',
      ...
      step4: {
        ...
        errorMessage: 'Please try again in a moment, or reach us directly and we will arrange everything personally.',
        retry: 'Try again →',
      },
    },
  ...
  es: {
    ...
    bookingPage: {
      ...
      step2: {
        ...
        phoneNote: 'Lo usamos solo para coordinar tu llegada.',
        companyLabel: 'Empresa',
        optionalCompany: '(opcional)',
      ...
      step4: {
        ...
        errorMessage: 'Probá de nuevo en un momento, o contactanos directamente y coordinamos todo de forma personal.',
