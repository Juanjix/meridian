  ...
  const cardConfig = [
    {
      ...
      topLine: 'linear-gradient(90deg, transparent, rgba(154,154,154,0.18), transparent)',
    ...
    },
    {
      ...
      topLine: 'linear-gradient(90deg, transparent, rgba(212,175,95,0.55), transparent)',
    ...
    },
    {
      ...
      borderColor: 'rgba(154,154,154,0.14)',
      topLine: 'linear-gradient(90deg, transparent, rgba(240,236,230,0.15), transparent)',
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        ...
        <div className="mb-16 md:mb-24 text-center">
          ...
          <div style={{ overflow: 'hidden', paddingBottom: '0.1em', marginBottom: '-0.1em' }}>
            ...
            >
              {g.headline1}{' '}
              <span className="italic" style={{ color: 'rgba(212,175,95,0.82)' }}>{g.headline2}</span>
            </motion.h2>
          </div>
          ...
          {g.cards.map((card, i) => {
            ...
            return (
              <motion.div
                ...
                transition={{ duration: 1.0, ease: EASE_CINEMA, delay: 0.28 + i * 0.14 }}
                whileHover={{ y: -10, transition: { duration: 0.60, ease: EASE_APPLE } }}
              ...
              >
                ...
                >
                  {/* Ambient glow */}
                  <div className="absolute inset-0 pointer-events-none" style={{ background: cfg.glow }} />

                  {/* Top accent line */}
                  <div className="absolute top-0 inset-x-0 h-px" style={{ background: cfg.topLine }} />
                  ...
                  <div className="relative z-10 flex flex-col flex-1 p-8 md:p-9">
                    ...
                    <div
                      ...
                      style={{
                        ...
                        color: cfg.isFeatured ? '#F0ECE6' : 'rgba(240,236,230,0.82)',
                      }}
                    >
                      {card.price}
                    </div>
                    ...
                    <h3
                      ...
                      style={{
                        ...
                        color: cfg.isFeatured ? '#F0ECE6' : 'rgba(240,236,230,0.75)',
                      }}
                    >
                      {card.title}
                    </h3>
                    ...
                    <div
                      ...
                      style={{ background: cfg.isFeatured ? 'rgba(212,175,95,0.14)' : 'rgba(154,154,154,0.10)' }}
                    />

                    {/* Description */}
                    <p className="text-xs font-light leading-relaxed flex-1" style={{ color: '#888888' }}>
                      {card.desc}
                    </p>
                    ...
                    <button
                      ...
                      style={{
                        border: `1px solid ${cfg.borderColor}`,
                        color: cfg.isFeatured ? 'rgba(212,175,95,0.88)' : 'rgba(240,236,230,0.55)',
                        background: 'transparent',
                      }}
                      onMouseEnter={(e) => {
                        const el = e.currentTarget
                        el.style.borderColor = cfg.isFeatured ? 'rgba(212,175,95,0.60)' : 'rgba(154,154,154,0.35)'
                        el.style.color = cfg.isFeatured ? 'rgba(212,175,95,1)' : 'rgba(240,236,230,0.90)'
                        el.style.background = cfg.isFeatured ? 'rgba(212,175,95,0.06)' : 'rgba(154,154,154,0.04)'
                      }}
                      onMouseLeave={(e) => {
                        const el = e.currentTarget
                        el.style.borderColor = cfg.borderColor
                        el.style.color = cfg.isFeatured ? 'rgba(212,175,95,0.88)' : 'rgba(240,236,230,0.55)'
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {g.forWhom.map((tag) => (
              <span
                ...
                style={{ border: '1px solid rgba(154,154,154,0.14)', color: 'rgba(184,184,184,0.55)' }}
              >
                {tag}
              </span>
            ))}
          ...
          <p className="text-2xs font-light tracking-[0.12em] text-center" style={{ color: 'rgba(154,154,154,0.45)' }}>
            {g.ctaSub}
          </p>
        </motion.div>
      </div>
